    ...
    <div className={cn("flex flex-col h-full", className)}>
      ...
      <div className="flex items-center justify-between p-3 border-b border-border">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 bg-[#7FFFC3] text-gray-900 rounded-md text-sm font-medium hover:bg-[#6ee6b0] transition-colors disabled:opacity-50"
        >
          {isLaunching ? (
            <>
